      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          {PROJECTS.map((project) => (
            <div key={project.title} className="bg-zinc-900 rounded-xl sm:rounded-2xl p-0 shadow-lg border border-zinc-800 flex flex-col overflow-hidden hover:border-blue-100/50 transition-all duration-500 hover:shadow-blue-500/20 hover:shadow-2xl hover:-translate-y-2">
              ...
              <div className="p-4 sm:p-6 flex flex-col flex-1">
                ...
                <a 
                  ...
                  className="text-blue-400 hover:text-blue-300 hover:underline mt-auto text-sm sm:text-base font-medium flex items-center gap-1.5 sm:gap-2 group-hover:gap-2 sm:group-hover:gap-3 transition-all duration-300"
                >
                  View Project
